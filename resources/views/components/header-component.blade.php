<header class="header">
        <div class="container">
            ...
            <div class="header-content">
                ...
                <button class="btn btn-primary btn-rounded"><i class="bi bi-printer pr-2"></i><a href="https://flowcv.com/resume/lphp12e4sr" target="_blank"  style="text-decoration: none; color:white">view Resume</a></button>
            </div>
        </div>
    </header>